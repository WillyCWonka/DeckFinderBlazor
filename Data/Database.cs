...
class LogWrapper : Neo4j.Driver.ILogger
{
    ...
    public void Debug(string message, params object[] args) => Console.WriteLine(message, args);
    public void Trace(string message, params object[] args) => Console.WriteLine(message, args);
...
public class Database : IDisposable
{
    ...
    {
        _driver = GraphDatabase.Driver(uri, AuthTokens.Basic(user, password), o => { o.WithLogger(new LogWrapper()); });
    }
